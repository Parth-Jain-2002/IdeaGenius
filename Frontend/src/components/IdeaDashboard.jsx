    ...
    <div className="w-full h-full p-4">
      ...
      <div className="flex w-full mt-6">
        <div className="w-2/3 h-full flex flex-col gap-2 rounded-l-lg bg-gray-100">
          ...
          <button className="p-2 mb-2 ml-4 w-32 rounded-xl bg-blue-300">
            Explore More
          </button>
        </div>
        <div className="w-1/3 border-l-2 h-full flex flex-col gap-2 rounded-r-lg ">
          <h1 className="text-xl font-medium px-4 py-2">
            Recommended People on Trumio
          </h1>
          <div className=" px-4">
            <div className="my-1">
              <PeopleCard.Small name="John Doe" jobTitle="Software Engineer" />
            </div>
            <div className="my-1">
              <PeopleCard.Small name="Jack Black" jobTitle="UI/UX Designer" />
            </div>
            <div className="my-1">
              <PeopleCard.Small
                name="Jill White"
          ...
          <a
            className="p-2 mb-2 w-32 rounded-xl bg-blue-300 ml-auto mr-4 text-center"
            href={`/people/${topicid}`}
          >
            Explore More
          </a>
