def questions_answer(answer):
    prompt = f"""1. Current challenge or pain point? {answer[0]}
...
def idea_generation(answer):
    ...
    prompt = f"""Trumio is at the forefront of revolutionizing education and industry collaboration with its AI-driven University Project Ecosystem on the Cloud. This platform connects students and industry professionals, fostering real-world project engagement. The system operates across three key domains: Marketplace, Network, and Work Platform, offering a comprehensive solution for project management, team interaction, and secure collaboration with an AI-assisted CoPilot.

    The overarching goal of Trumio is to reshape the future of work by creating a bridge between academia and industry. Students gain valuable real-world experience, professors enhance industry engagement, and clients benefit from accelerated project execution. Notably, alumni are invited to contribute to three AI-driven integrations, playing a crucial role in shaping the future of education and the workplace.
